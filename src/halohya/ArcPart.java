...
public class ArcPart extends DrawPart {
    ...
    public float shapeFraction = 0.5f, shapeFractionTo = -1;//от 0 до 1 часть круга, 0.5 это половина круга, если shapes = 2 то замкнётся в круг
    ...
    public void draw(PartParams params){
        ...
        for(int s = 0; s < shapes; s++){
            ...
            Lines.arc(params.x, params.y, rad, sf, rot);
        }
    }
    @Override
